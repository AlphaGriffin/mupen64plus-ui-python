...
class Worker(QThread):
    ...
    def __init__(self, ui, folders=""):
        """Init elements for Qthread process."""
        QThread.__init__(self, ui)
        self.ui = ui
        self.folders = folders

    def run(self):
        """The method run by Thead.start()."""
        log.debug()
        try:
            ...
            self.ui.print_console(
                "#############################################")
            self.ui.print_console(
                "# Processing Game folders to dataset")
            self.ui.print_console(
                "# Game Name: {}".format(self.ui.currentGame))
            self.ui.print_console(
                "# Dataset Path: {}".format(saveDir))
            self.ui.print_console(
                "# Number of saves to process: {}".format(
                    len(folders)
                    ))
            self.ui.print_console(
                "#############################################")
