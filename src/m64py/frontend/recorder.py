...
# The reason is that the recoder (small r) object is what is being imported, not the real class
# couldnt tell you why though. its a supered class, so... i cant say why you would pre init it like this?
#recorder = Recorder()
